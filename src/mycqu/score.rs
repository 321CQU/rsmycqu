...
impl GPARanking {
    ...
    fn from_json(json_map: &Map<String, Value>) -> Option<Self> {
        Some(GPARanking {
            ...
            major_ranking: json_map
                .get("majorRanking")
                .and_then(Value::as_str)
                .and_then(|s| s.parse::<u16>().ok()),
            grade_ranking: json_map
                .get("gradeRanking")
                .and_then(Value::as_str)
                .and_then(|s| s.parse::<u16>().ok()),
            class_ranking: json_map
                .get("classRanking")
                .and_then(Value::as_str)
                .and_then(|s| s.parse::<u16>().ok()),
            weighted_avg: json_map
                .get("weightedAvg")
                .and_then(Value::as_str)
                .and_then(|s| s.parse::<f32>().ok())?,
            minor_weighted_avg: json_map
                .get("minorWeightedAvg")
                .and_then(Value::as_str)
                .and_then(|s| s.parse::<f32>().ok()),
            minor_gpa: json_map
                .get("minorGpa")
