...
pub(super) fn encrypt_password(page_crypto: impl AsRef<str>, password: impl AsRef<str>) -> SSOResult<String> {
    let crypto = BASE64PURPOSE.decode(page_crypto.as_ref()).map_err(|_| SSOError::PasswordEncryptError)?;
